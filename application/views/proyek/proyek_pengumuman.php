<div class="wrapper content-wrapper">
    ...
    <div class="page-heading">
        <ol class="breadcrumb mt-4">
            ...
            <li class="breadcrumb-item">Pengumuman Lelang</li>            
        </ol>
    </div>	
    <!-- START PAGE CONTENT-->
    <div class="page-content fade-in-up">
		<div class="row">
		    <div class="col-xl-12 col-lg-12 col-xs-12">
		        <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">PENGUMUMAN LELANG | NOMOR : <?php echo strtoupper((isset($data_tabel)?$data_tabel['no_reg']:'')) ?></div>
                    </div>        	
		            
                    <form class="form-info" novalidate enctype="multipart/form-data" method="post" action="<?php  echo base_url().'Proyek/'.$action ?>" id="mydropzone"> 
                    <div class="ibox-body">
